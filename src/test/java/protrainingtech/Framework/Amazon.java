...
public class Amazon {
 ...
 @Test
  ...
  private void Try_prime1(WebDriver driver2) {
	  
	// TODO Auto-generated method stub
	
}
@Test
  public void try_prime() {
	  Try_prime prime=new Try_prime(driver);
	  prime.tryprimeclick();
  }
  
 @Test
 public void try_prime1() throws InterruptedException {
	 new Primitive(driver);
     prime1.primitiveclick();		 
 }
